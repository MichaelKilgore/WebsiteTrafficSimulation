Synopsis:\
This program essentially simulates a website having traffic. The timeserver created by my instructor, is meant to be run on a server, this starts a website. The trafficgen is used to simulate pings sent to the website. Then the Collector periodically sample the server statistic. This was run for an hour, and all the data collected was thrown into the output.tsv file. Finally plot.py was used to plot all the data collected onto a graph in the graph.png.\
\
Usage:\
